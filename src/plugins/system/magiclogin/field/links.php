...
class JFormFieldLinks extends FormField
{
    ...
    {
        $buttons = [
            ['link' => 'https://www.alikonweb.it', 'class' => 'btn-primary', 'icon' => 'fas fa-book', 'label' => 'PLG_SYSTEM_MAGICLOGIN_LBL_MANUAL'],
            ['link' => 'https://www.x.com/Alikon', 'class' => 'btn-primary', 'icon' => 'fab fa-x-twitter', 'label' => 'PLG_SYSTEM_MAGICLOGIN_LBL_FOLLOW'],
            ['link' => 'https://github.com/alikon/testcom/issues', 'class' => 'btn-danger', 'icon' => 'fas fa-bug', 'label' => 'PLG_SYSTEM_MAGICLOGIN_LBL_REPORT'],
            ['link' => 'https://github.com/sponsors/alikon', 'class' => 'btn-success', 'icon' => 'fab fa-github', 'label' => 'PLG_SYSTEM_MAGICLOGIN_LBL_SPONSOR'],
        ];
