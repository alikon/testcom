...
class JobModel extends AdminModel
{
	 ...
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_JOBS';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jobs.link', 'link', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_jobs.edit.link.data', array());
		...
		$this->preprocessData('com_jobs.link', $data);
