...
use Joomla\CMS\Router\Exception\MethodDisabledException;
...
final class ApiApplication extends CMSApplication
{
	...
	protected function route()
	{
		...
		$this->triggerEvent('onBeforeApiRoute', array(&$router, $this, $method));
		...
		if ($this->input->get('requestDisabled', 'false') === 'true')
		{
...
/**
			...
			{
				$ratelimit   = $this->input->get('ratelimit', 'false');

				if ($ratelimit === 'true' && $route['vars']['public'] === true)
				{
